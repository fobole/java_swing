...
public class Kkcpd2 {	
	...
	private int cstate;
	public Kkcpd2(int chid, int lid, int gid, int chkushu, int chpanshu, String chremaarks, int stid, int stshu,
			int stmax, int stmin, String stopera, Date stdate, String gname, Double gprice, String gspec, int cid,
			int sid, String gopera, Date gdate, String ctype, int cstate) {
		super();
		this.chid = chid;
		this.lid = lid;
		this.gid = gid;
	...
	public Kkcpd2(int gid, int stshu, String gname, Double gbid, Double gprice, String gspec) {
		super();
		this.gid = gid;
		this.stshu = stshu;
		this.gname = gname;
