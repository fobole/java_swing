...
public class Xm2zengjia extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public Xm2zengjia(JFrameInterface JDialog) {
...
//					int sid=Integer.parseInt(textField_11.getText());
//					int sztai=Integer.parseInt(textField_9.getText());
//					String gopera=textField_5.getText();
					Date gdate=new Date();
...
//				}
					...
					Xm2st good=new Xm2st( gname, gbid, gprice, gspec, 2, 1, 0, "小丰",gdate);
					try {
						int isok=dao1.intstevip(good);
						if(isok>0){
