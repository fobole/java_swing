...
public class Caigou_tuihuoshu_ui2 extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Caigou_tuihuoshu_ui2(JFrameInterface jframe) {
		//将传回的父窗口进行接收
...
//		}
		...
		JLabel label_6 = new JLabel("当前数量：");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Caigou_tuihuoshu_ui2.this.dispose();
			}
		});
...
//				label_12.setText(table_2.);
				//库存
				int kucun=(int) gui.table_2.getValueAt(row, 4);
				if(stshu>kucun) {
