...
public class Caigou_geshu_ui extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Caigou_geshu_ui(JFrameInterface jframe) {
		//将传回的父窗口进行接收
		this.gui=(Caigou_jiujia_ui) jframe.getJFrame();
		setTitle("商品信息");
...
//				}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Caigou_geshu_ui.this.dispose();
			}
		});
		button_1.setFont(new Font("微软雅黑", Font.BOLD, 25));
		button_1.setBounds(51, 293, 131, 44);
		...
		button.setBounds(427, 293, 118, 44);
		panel_1.add(button);
