...
public class Caigou_tuihuoshu_ui3 extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Caigou_tuihuoshu_ui3(JFrameInterface jframe) {
		//将传回的父窗口进行接收
				this.gui=(Caigou_tui_ui) jframe.getJFrame();
				setTitle("商品信息");
...
//				}
				...
				panel_1.add(label_9);
				 ...
				 label_12 = new JLabel(gui.cj.getXpshu()+"");
				...
				button_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						Caigou_tuihuoshu_ui3.this.dispose();
					}
				});
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(stshu>Integer.parseInt(label_12.getText())) {
							JOptionPane.showMessageDialog(null, "退货数不能大于库存");
