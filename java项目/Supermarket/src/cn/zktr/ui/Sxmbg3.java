...
public class Sxmbg3 extends JDialog {
	...
	public Sxmbg3() {
		...
		}
		{
			...
			}
			{
				...
				textField_2.setBounds(612, 12, 189, 24);
...
//			        table_1.setGridColor(Color.red);
	...
	public List<S_jintuihuo_danju> findDb() throws Exception{
		...
		if(textField_2.getText().equals(null) || textField_2.getText().equals("")){
			...
			list=xtdao.danju(textField_2.getText());
		}
		//2.如果下拉框中有值，则带条件查询
		return list;
	}
