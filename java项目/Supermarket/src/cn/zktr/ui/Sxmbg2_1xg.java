...
public class Sxmbg2_1xg extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Sxmbg2_1xg(JFrameInterface jframe) {
		this.gui=(Sxmbg2) jframe.getJFrame();
		...
		JLabel label_9 = new JLabel("销售总数：");
		label_9.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		label_9.setBounds(61, 268, 92, 28);
		contentPanel.add(label_9);
		
		JLabel lblNewLabel = new JLabel(gui.cj.getStshu()+"");
		lblNewLabel.setFont(new Font("微软雅黑", Font.PLAIN, 15));
		lblNewLabel.setBounds(143, 276, 74, 15);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int sdshu=Integer.parseInt(lblNewLabel.getText());
...
//				//获得当前选中行的下标
				...
				gui.lxiao.set(row, new Sgoods_jiujia(gname, gprice, gspec, stshu,zsj,sdshu));
