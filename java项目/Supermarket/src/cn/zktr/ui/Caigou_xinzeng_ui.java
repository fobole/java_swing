...
public class Caigou_xinzeng_ui extends JDialog {
...
//	C_TypeDao tdao=new C_TypeDao();
	 ...
	 * 新商品添加界面
	 */
	public Caigou_xinzeng_ui(JFrameInterface jframe) {
		//将传回的父窗口进行接收
...
//					System.out.println("--------------------"+sid);
					...
					int max=Integer.parseInt(textField_5.getText());
					//商品编号
...
//						System.out.println(gid);
						//库存表
						ghao.insertstock(new C_jintuihuo_danju(gid, 0, max, min, gopera, new Date()));
						c.setGid(gid);
					}catch (Exception e2) {
						// TODO Auto-generated catch block
						e2.printStackTrace();
					...
					try {
						gui.updateTablecai();
						Caigou_xinzeng_ui.this.dispose();
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
