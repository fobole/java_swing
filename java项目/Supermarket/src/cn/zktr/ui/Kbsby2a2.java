...
public class Kbsby2a2 extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Kbsby2a2(JFrameInterface jframe) {
		//将传回的父窗口进行接收
		this.gui=(KXmjm2absby) jframe.getJFrame();
		setTitle("商品信息");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Kbsby2a2.class.getResource("/img/logo544.png")));
//		try {
...
//		}
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				gui.list2.set(row, new Cgoods_jiujia(gid, gname, gbid, gprice, gspec, stshu));
