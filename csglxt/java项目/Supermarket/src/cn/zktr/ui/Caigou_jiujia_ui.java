...
public class Caigou_jiujia_ui extends JDialog {
...
//	    }
	 ...
	 * Create the dialog.
	 */
	public Caigou_jiujia_ui(JFrameInterface jframe) {
		this.cai=(Caiguo_cai_ui) jframe.getJFrame();
								 ...
								 if (e.getClickCount() == 2) {
									//先判断是否选中行
										if(table_1_1.getSelectedRow()<0){
											...
											//打开新增窗口,将当前父窗口传到子窗口中
											Caigou_geshu_ui add=new Caigou_geshu_ui(new JFrameInterface() {
												@Override
												public JDialog getJFrame() {
													// TODO Auto-generated method stub
													return Caigou_jiujia_ui.this;
												}
											});
										}
								 }
				...
				btnf.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(table_2.getSelectedRow()<0){
							...
							cj=new Cgoods_jiujia(gid, gname, gbid, list2.get(row).getGprice(), gspec,list2.get(row).getStshu(),list2.get(row).getKucun());
//							System.out.println(cj.toString());
							//打开新增窗口,将当前父窗口传到子窗口中
							Caigou_geshu_ui2 add=new Caigou_geshu_ui2(new JFrameInterface() {
								@Override
								public JDialog getJFrame() {
									// TODO Auto-generated method stub
									return Caigou_jiujia_ui.this;
