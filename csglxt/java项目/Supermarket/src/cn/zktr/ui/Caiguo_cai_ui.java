...
public class Caiguo_cai_ui extends JDialog {
...
//            @Override
//            public void run() {
//            	Caiguo_cai_ui frame = new Caiguo_cai_ui();
//                frame.setVisible(true);
//               
//            }
//        });
//    }
	public Caiguo_cai_ui(JFrameInterface2 j) {
		...
		JButton btnNewButton = new JButton("采购进货");
		btnNewButton.setFont(new Font("微软雅黑", Font.BOLD, 20));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JButton but=(JButton) e.getSource();
				if (but.getText().equals("采购进货")) {
					car.show(panel, "name_149830963598100");
				}
			}
		});
		btnNewButton.setBounds(14, 13, 134, 37);
		contentPanel.add(btnNewButton);
		
		panel = new JPanel();
		panel.setBounds(14, 58, 1199, 664);
		...
		{
			JLabel label = new JLabel("采购进货");
			label.setFont(new Font("华文楷体", Font.BOLD, 50));
			label.setBounds(442, 6, 213, 45);
			panel_1.add(label);
		}
		{
			lblx = new JLabel("CJ"+sdf.format(new Date()));
			lblx.setForeground(Color.RED);
			lblx.setFont(new Font("宋体", Font.BOLD, 16));
			lblx.setBounds(976, 25, 213, 29);
			panel_1.add(lblx);
		}
		
		JPanel panel_3 = new JPanel();
		panel_3.setBackground(new Color(248, 248, 255));
		panel_3.setBounds(10, 60, 1179, 59);
		panel_1.add(panel_3);
		panel_3.setLayout(null);
		
		JLabel label = new JLabel("供应商：");
		label.setFont(new Font("微软雅黑", Font.BOLD, 25));
		label.setBounds(10, 19, 111, 32);
		panel_3.add(label);
		...
		label_1.setBounds(409, 16, 94, 39);
		panel_3.add(label_1);
...
//        p.add(l);
		...
		comboBox_1.setBounds(116, 21, 146, 32);
		panel_3.add(comboBox_1);
		
		JLabel lblNewLabel_1 = new JLabel(sdf2.format(new Date()));
		lblNewLabel_1.setFont(new Font("微软雅黑", Font.BOLD, 20));
		lblNewLabel_1.setBounds(936, 19, 220, 32);
		panel_3.add(lblNewLabel_1);
		
		JPanel panel_4 = new JPanel();
		panel_4.setBounds(10, 129, 1179, 59);
		panel_1.add(panel_4);
		panel_4.setLayout(null);
		{
			JButton btnf = new JButton("老商品添加");
			btnf.setFont(new Font("微软雅黑", Font.BOLD, 20));
			btnf.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Caigou_jiujia_ui cjiu=new Caigou_jiujia_ui(new JFrameInterface() {
						
						@Override
						public JDialog getJFrame() {
							// TODO Auto-generated method stub
							return Caiguo_cai_ui.this;
						}
					});
				}
			});
		...
		{
			JButton btnf_1 = new JButton("新商品添加");
			btnf_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Caigou_xinzeng_ui c=new Caigou_xinzeng_ui(new JFrameInterface() {
		...
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRow()<0){
					...
					Caigou_geshu_ui3 c=new Caigou_geshu_ui3(new JFrameInterface() {
		...
		button_1.setBounds(762, 14, 155, 30);
		panel_4.add(button_1);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 198, 1179, 364);
...
//        table_1.setGridColor(Color.red);
		...
		comboBox_2.setBounds(565, 29, 123, 28);
		panel_5.add(comboBox_2);
		
		JLabel label_5 = new JLabel("实付金额：");
		label_5.setFont(new Font("微软雅黑", Font.BOLD, 20));
		label_5.setBounds(240, 29, 104, 28);
		panel_5.add(label_5);
		...
		textField_4_1.setBounds(340, 29, 111, 30);
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Caigou_shenhezhuantai_ui c=new Caigou_shenhezhuantai_ui(new JFrameInterface() {
		...
		button_6.setBounds(1048, 28, 99, 31);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					Caiguo_cai_ui.this.dispose();
			}
		});
		button.setFont(new Font("微软雅黑", Font.BOLD, 20));
		button.setBounds(881, 28, 99, 31);
		panel_5.add(button);
		
		JLabel label_10 = new JLabel("单号：");
		label_10.setFont(new Font("微软雅黑", Font.BOLD, 20));
		label_10.setBounds(889, 22, 66, 30);
		...
		panel_6.setBounds(10, 10, 1179, 80);
		panel_2.add(panel_6);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(table_1_1.getSelectedRow()<0) {
					JOptionPane.showConfirmDialog(null, "请选择数据行");
				}else {
		...
		button_2.setBounds(25, 10, 74, 61);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(list2.size()==0) {
					JOptionPane.showMessageDialog(null, "没商品");
				}else {
					Caigou_shenhe_ui c=new Caigou_shenhe_ui(new JFrameInterface() {
		...
		button_3.setBounds(125, 10, 74, 61);
		panel_6.add(button_3);
		
		JLabel label_7 = new JLabel("单据号/供应商：");
		label_7.setFont(new Font("微软雅黑", Font.BOLD, 20));
		label_7.setBounds(679, 33, 177, 27);
		panel_6.add(label_7);
		...
		textField_6_1.setBounds(830, 27, 197, 39);
		...
		btnf_2.setBounds(1057, 33, 95, 27);
		panel_6.add(btnf_2);
		
		 scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(10, 100, 1179, 223);
...
//        }
		...
		panel_7.setBounds(10, 333, 1179, 51);
		panel_2.add(panel_7);
		...
		lblNewLabel.setBounds(95, 7, 132, 31);
		...
		btnNewButton_1.setBounds(750, 12, 0, 31);
		...
		button_4.setBounds(894, 10, 0, 34);
		...
		button_5.setBounds(1034, 10, 0, 34);
		panel_7.add(button_5);
		
		textField_7 = new JTextField();
		
		 scrollPane_2 = new JScrollPane();
		scrollPane_2.setBounds(10, 394, 1179, 260);
...
//        table_1.setGridColor(Color.red);
		...
		JButton button_9 = new JButton("单据审核");
		button_9.setFont(new Font("微软雅黑", Font.BOLD, 20));
		button_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JButton but=(JButton) e.getSource();
				if(gui.lblZhiwei.getText().equals("超级管理员")) {
					
					if (but.getText().equals("单据审核")) {
		...
		button_9.setBounds(203, 13, 134, 37);
...
//		table_1_1.getColumnModel().getColumn(0).setPreferredWidth(190);
//	    table_1_1.getColumnModel().getColumn(2).setPreferredWidth(210);
		return tm;
	}
	/**
	 * 通用查询
	...
	public List<C_jintuihuo_danju> findDb() throws Exception{
		...
		if(textField_6_1.getText().equals(null) || textField_6_1.getText().equals("")){
			...
			list=ddao.weishenhe(textField_6_1.getText());
		}
		//2.如果下拉框中有值，则带条件查询
		return list;
	}
...
//		public List<C_danju_xiangqin> findDb2() throws Exception{
//			//1.如果第一次来，输入框中无值，则查询所有
//			
//			if(list2.size()>0) {
//				String podd=(String) table_1_1.getValueAt(0, 0);
//				list2=ddao.weishenhe_xiang(podd);
//			}
//			
//		
