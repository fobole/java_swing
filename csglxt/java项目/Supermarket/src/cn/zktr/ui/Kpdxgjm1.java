...
public class Kpdxgjm1 extends JDialog {
...
//	}
	 ...
	 * Create the dialog.
	 */
	public Kpdxgjm1(JFrameInterface jframe) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//获得当前选中行的下标
				int row=pan.table_1.getSelectedRow();
				for (int i = 0; i < pan.list2.size(); i++) {
					if(row==i) {
						Kkcpd3 g=pan.list2.get(i);
						  g.setStshu(shu);
					}
