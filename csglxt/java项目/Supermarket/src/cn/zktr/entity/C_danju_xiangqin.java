...
public class C_danju_xiangqin {
		private int xpid;
		private String xpodd;
		private int xpshu;
		private int gid;
		...
		public String getXpodd() {
			return xpodd;
		}
		public void setXpodd(String xpodd) {
			this.xpodd = xpodd;
		}
		public int getXpid() {
			return xpid;
		...
		public C_danju_xiangqin(int xpid, int xpshu, int gid, String gname, double gbid, double gprice, String gspec,
				int gztai, double pcope) {
			super();
			this.xpid = xpid;
			this.xpshu = xpshu;
			this.gid = gid;
